...
local core_plugins = {
  ...
  {
    "L3MON4D3/LuaSnip",
    -- build = "make install_jsregexp", -- see javascript regular expressions for lua
    config = function()
      vim.api.nvim_set_keymap("i", "jk", "<Plug>luasnip-expand-or-jump", { desc = "Expand snip or jump next" })
      vim.api.nvim_set_keymap("s", "jk", "<Plug>luasnip-expand-or-jump", { desc = "Expand snip or jump next" })
      vim.api.nvim_set_keymap("i", "kj", "<Plug>luasnip-jump-prev", { desc = "Jump previous snip item" })
      vim.api.nvim_set_keymap("s", "kj", "<Plug>luasnip-jump-prev", { desc = "Jump previous snip item" })
