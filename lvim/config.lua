...
--[[
-- Note for windows: the rest of the config is placed in AppData/Roaming/lunarvim
--]]
...
-- you can override default vim options here if you want
-- vim.opt.shiftwidth = 2
-- vim.opt.tabstop = 2
-- vim.opt.relativenumber = true

-- This should make nvim a bit faster
vim.opt.timeoutlen = 500
vim.opt.history = 5 -- number of items to remember in history
vim.opt.ttyfast = true
vim.opt.lazyredraw = true
-- vim.opt.textwidth = 80 -- new line after 80th character
